...
qk_tap_dance_action_t tap_dance_actions[] = {
  [KC_W] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, w, NULL, KEY_TAP_TIMEOUT),
  [KC_E] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, e, NULL, KEY_TAP_TIMEOUT),
  [KC_R] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, r, NULL, KEY_TAP_TIMEOUT),
  [KC_F] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, f, NULL, KEY_TAP_TIMEOUT),
  [KC_A] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, a, NULL, KEY_TAP_TIMEOUT),
  [KC_S] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, s, NULL, KEY_TAP_TIMEOUT),
  [KC_D] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, d, NULL, KEY_TAP_TIMEOUT),
  [KC_T] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, t, NULL, KEY_TAP_TIMEOUT),
  [KC_G] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, g, NULL, KEY_TAP_TIMEOUT),
  [KC_Z] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, z, NULL, KEY_TAP_TIMEOUT), // german y
  [KC_X] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, x, NULL, KEY_TAP_TIMEOUT),
  [KC_C] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, c, NULL, KEY_TAP_TIMEOUT),
  [KC_V] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, v, NULL, KEY_TAP_TIMEOUT),
  [KC_B] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, b, NULL, KEY_TAP_TIMEOUT),
  [KC_Y] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, y, NULL, KEY_TAP_TIMEOUT), // german z
  [KC_U] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, u, NULL, KEY_TAP_TIMEOUT),
  [KC_I] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, i, NULL, KEY_TAP_TIMEOUT),
  [KC_O] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, o, NULL, KEY_TAP_TIMEOUT),
  [KC_H] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, h, NULL, KEY_TAP_TIMEOUT),
  [KC_N] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, n, NULL, KEY_TAP_TIMEOUT),
  [KC_K] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, k, NULL, KEY_TAP_TIMEOUT),
  [KC_L] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, l, NULL, KEY_TAP_TIMEOUT),
  [KC_P] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, p, NULL, KEY_TAP_TIMEOUT),
  [KC_J] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, j, NULL, KEY_TAP_TIMEOUT),
  [KC_M] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, m, NULL, KEY_TAP_TIMEOUT),
  [KC_COMMA] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, comma, NULL, KEY_TAP_TIMEOUT),
  [KC_DOT] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, dot, NULL, KEY_TAP_TIMEOUT),
  [KC_SLASH] = ACTION_TAP_DANCE_FN_ADVANCED_TIME(NULL, slash, NULL, KEY_TAP_TIMEOUT),
};
